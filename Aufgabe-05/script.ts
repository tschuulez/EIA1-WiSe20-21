...
console.log("That is a growth rate of approximatley " + Math.round(africa18-africa08) + "kg CO2")
...
console.log("That is a growth rate of approximatley " + Math.round(southAmerica18-southAmerica08) + "kg CO2")
...
console.log("That is a growth rate of approximatley " +  Math.round(europe18-europe08) + "kg CO2")
...
console.log("That is a growth rate of approximatley " +  Math.round(northAmerica18-northAmerica08) + "kg CO2")
...
console.log("That is a growth rate of approximatley " +  Math.round(asia18-asia08) + "kg CO2")
...
console.log("That is a growth rate of approximatley "  +  Math.round(australia18-australia08) + "kg CO2")
