...
console.log("Africa's emission from 2018 has increased by " + Math.round(africa18/africa08*100)  + " since 2008")
...
console.log("South America's emission from 2018 has increased by " + Math.round(southAmerica18/southAmerica08*100)  + " since 2008")
...
console.log("Europe's emission from 2018 has increased by " +  Math.round(europe18/europe08*100)  + " since 2008")
...
console.log("North America's emission from 2018 has increased by " +  Math.round(northAmerica18/northAmerica08*100)  + " since 2008")
...
console.log("Asia's emission from 2018 has increased by " +  Math.round(asia18/asia08*100)  + " since 2008")
...
console.log("Australia's emission from 2018 has increased by "  +  Math.round(australia18/australia08*100)  + " since 2008")
